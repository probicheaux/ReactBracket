...
export default function TournamentDetailsScreen({ navigation, route }: DetailScreen) {
        ...
        return (
            ...
            <View style={styles.centeredView}>
              <View style={styles.modalView}>
                <Text style={styles.modalText}>Add a Bracket to {tournament.name}</Text>
                <TextInput placeholder="Bracket name" style={styles.textInput} onChangeText={(t) => setBracket({ ...bracket, name: t })}/>
                <LinkButton title="Add" onPress={() => submitAddBracket()}/>
                <LinkButton title="Cancel" onPress={() => setShowAddBracketModal(!showAddBracket)}/>
              </View>
            </View>
          </Modal>  
        );
    ...
    return (
        <View style={styles.container}>
            ...
            <LinkButton title="Add Bracket" onPress={() => setShowAddBracketModal(true)} style={{ marginTop: 24 }} />
        </View>
    );
}
